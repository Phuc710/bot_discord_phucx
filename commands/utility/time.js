    ...
    async execute(interaction) {
        ...
        if (subcommand === 'timer') {
            ...
            if (minutes <= 0 || minutes > 1440) { // Max 24 hours
                return interaction.reply({ content: 'Please enter a valid duration between 1 and 1440 minutes (24 hours).', ephemeral: true });
            }
            ...
            if (minutes <= 0 || minutes > 10080) { // Max 1 week
                return interaction.reply({ content: 'Please enter a valid time between 1 and 10080 minutes (1 week).', ephemeral: true });
            }
